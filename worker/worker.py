...
class TaskProcessor:
    ...
    def process_task(self, task_data):
        ...
        try:
            ...
            start_msg = f'[{ts}] Task processing started'
            ...
            ts_done = datetime.utcnow().isoformat()
            done_msg = f'[{ts_done}] Task completed successfully'
            ...
            ts_fail = datetime.utcnow().isoformat()
            fail_msg = f'[{ts_fail}] Task failed: {str(e)}'
    ...
    def start(self):
        ...
        while True:
            try:
                ...
                logger.error(
                    "Redis connection error. Retrying in 5 seconds..."
                )
                time.sleep(5)
